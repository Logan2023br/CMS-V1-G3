...
You can access it at: https://manual-mcp.pagefly.io/mcp
...
#### Step 3 — Enter your MCP server's URL (either your hosted/tunneled URL our [hosted version](https://manual-mcp.pagefly.io/mcp)) and hit **Add MCP Server**.
